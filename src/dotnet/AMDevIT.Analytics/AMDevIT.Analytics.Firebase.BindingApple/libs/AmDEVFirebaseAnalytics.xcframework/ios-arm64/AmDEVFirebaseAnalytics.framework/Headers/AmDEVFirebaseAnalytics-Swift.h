...
#ifndef AMDEVFIREBASEANALYTICS_SWIFT_H
#define AMDEVFIREBASEANALYTICS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AmDEVFirebaseAnalytics",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM(NSInteger, AnalyticsConsentStatus, open) {
/// Leaves the previously configured value unchanged.
  AnalyticsConsentStatusUnchanged = 0,
/// Grants consent for the selected category.
  AnalyticsConsentStatusGranted = 1,
/// Denies consent for the selected category.
  AnalyticsConsentStatusDenied = 2,
};
...
- (BOOL)isCrashlyticsCollectionEnabled SWIFT_WARN_UNUSED_RESULT;
/// Reports whether the previous execution ended in a crash.
- (BOOL)didCrashDuringPreviousExecution SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC22AmDEVFirebaseAnalytics21CrashlyticsStackFrame")
...
- (nonnull instancetype)initWithSymbol:(NSString * _Nonnull)symbol file:(NSString * _Nonnull)file line:(NSInteger)line OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC22AmDEVFirebaseAnalytics19FirebaseCoreManager")
